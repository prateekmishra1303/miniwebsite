            ...
            {/* Connect Links */}
              <div>
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="https://www.linkedin.com/in/prateekmishra1303" target="_blank" rel="noopener noreferrer">
                  ...
                  <a href="mailto:prateek@example.com">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRfCe8PumZ5jhEGolAsIG_iv2LKJ6OBsw0V4Q&s" alt="Email" className="h-6 w-6 hover:scale-110 transition" />
                  </a>
                </div>
              </div>
          </div>
